...
- **Filter by category & cuisine** — dropdowns populated dynamically from the API; combinable filters
...
- **Favorites** — save recipes locally (`localStorage`) and filter the grid to favorites-only
